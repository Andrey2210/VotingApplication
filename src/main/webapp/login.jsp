...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Sign in to continue to Vote Service</h1>
            ...
            <a href="${contextPath}/registration" class="text-center new-account">Create an account </a>
        </div>
    </div>
</div>
